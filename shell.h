...
ssize_t the_get_line1(char **str, size_t *output_SZ,FILE *reading_file);
...
int the_handle_cmd1(char **array_ofwrd, char *User_inp,char *my_shell_name, int counting_Cmd, int n);
